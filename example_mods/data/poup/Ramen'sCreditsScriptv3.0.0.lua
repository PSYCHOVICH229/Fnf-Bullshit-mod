...
{
	{--Template
	song = 'poup',--song name (exactly the same as the song name in the pause screen)
	coders = {'SPIMTOVICH',trash, {0,0}},--name,icon,iconOffset
	artists = {'Just_A_Voron',xl, {0,0}},--name,icon,iconOffset
	composers = {'aleshamalesha',leha, {0,0}},--name,icon,iconOffset
	charters = {'alehsamalesha,spimtovich',leha, {0,0}},--name,icon,iconOffset
