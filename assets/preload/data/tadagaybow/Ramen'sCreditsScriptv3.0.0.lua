...
--Credit would be very much appreciated for this thanks <3
--I'm so sorry for making the first version so awful 😭
--I'm also takin' away some features that are pretty useless ngl
--Icons must be in the 'images/credits' folder
...
{
	{--Template
	song = 'tadagaybow',--song name (exactly the same as the song name in the pause screen)
	coders = {'SPIMTOVICH',suka, {0,0}},--name,icon,iconOffset
	artists = {'Just_A_Voron',pn, {0,0}},--name,icon,iconOffset
	composers = {'aleshamalesha',pn, {0,0}},--name,icon,iconOffset
	charters = {'alehsamalesha,spimtovich',pn, {0,0}},--name,icon,iconOffset
	barFG = {'000000', '000000', '000000', '000000'}, --coder,artist,composer,charter
	barBG = {'FFFFFF', 'FFFFFF', 'FFFFFF', 'FFFFFF'}, --coder,artist,composer,charter
	textColor = {'000000', '000000', '000000', '000000'}, --coder,artist,composer,charter
...
function onCreate()
	...
	if #roleCredits[roleCreditSelected].artists[1]*25 < minLength then
		luaGraphic('creditsGraphicBa', -minLength-(150+roleCredits[roleCreditSelected].artists[3][1]), getProperty('creditsGraphicAa.y')+getProperty('creditsGraphicAa.height'), minLength, 90, roleCredits[roleCreditSelected].barBG[2])
	else
		luaGraphic('creditsGraphicBa', (-#roleCredits[roleCreditSelected].artists[1]*25)-(150+roleCredits[roleCreditSelected].artists[3][1]), getProperty('creditsGraphicAa.y')+getProperty('creditsGraphicAa.height'), #roleCredits[roleCreditSelected].artists[1]*25, 90, roleCredits[roleCreditSelected].barBG[2])
	end
	luaGraphic('creditsGraphicBb', getProperty('creditsGraphicBa.x'), getProperty('creditsGraphicBa.y')+5, getProperty('creditsGraphicBa.width')-5, getProperty('creditsGraphicBa.height')-10, roleCredits[roleCreditSelected].barFG[2])
	luaText('creditsTextBa', getProperty('creditsGraphicBb.x')+5, getProperty('creditsGraphicBb.y')+3, 30, '000000', 'FFFFFF', 'Art:')
	luaText('creditsTextBb', getProperty('creditsGraphicBb.x')+5, getProperty('creditsGraphicBb.y')+35, 40, roleCredits[roleCreditSelected].textColor[2], roleCredits[roleCreditSelected].textBorderColor[2], roleCredits[roleCreditSelected].artists[1])
	...
	if #roleCredits[roleCreditSelected].charters[1]*25 < minLength then
		luaGraphic('creditsGraphicDa', -minLength-(150+roleCredits[roleCreditSelected].charters[3][1]), getProperty('creditsGraphicCa.y')+getProperty('creditsGraphicCa.height'), minLength, 90, roleCredits[roleCreditSelected].barBG[4])
	else
		luaGraphic('creditsGraphicDa', (-#roleCredits[roleCreditSelected].charters[1]*25)-(150+roleCredits[roleCreditSelected].charters[3][1]), getProperty('creditsGraphicCa.y')+getProperty('creditsGraphicCa.height'), #roleCredits[roleCreditSelected].charters[1]*25, 90, roleCredits[roleCreditSelected].barBG[4])
	end
	luaGraphic('creditsGraphicDb', getProperty('creditsGraphicDa.x'), getProperty('creditsGraphicDa.y')+5, getProperty('creditsGraphicDa.width')-5, getProperty('creditsGraphicDa.height')-10, roleCredits[roleCreditSelected].barFG[4])
	luaText('creditsTextDa', getProperty('creditsGraphicDb.x')+5, getProperty('creditsGraphicDb.y')+3, 30, '000000', 'FFFFFF', 'Charting:')
	luaText('creditsTextDb', getProperty('creditsGraphicDb.x')+5, getProperty('creditsGraphicDb.y')+35, 40, roleCredits[roleCreditSelected].textColor[4], roleCredits[roleCreditSelected].textBorderColor[4], roleCredits[roleCreditSelected].charters[1])
