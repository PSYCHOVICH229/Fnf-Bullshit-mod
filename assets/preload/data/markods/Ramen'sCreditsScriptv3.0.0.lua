...
{
	{--Template
	song = 'markods',--song name (exactly the same as the song name in the pause screen)
	coders = {'SPIMTOVICH',suka, {0,0}},--name,icon,iconOffset
	artists = {'spimtovich',pn, {0,0}},--name,icon,iconOffset
	composers = {'Matt$ (cover spimtovich)',pn, {0,0}},--name,icon,iconOffset
	charters = {'idk who :(',pn, {0,0}},--name,icon,iconOffset
