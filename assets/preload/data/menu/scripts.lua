...
function onPass()
     if onGetKey('ENTER') then
          if num1 == 12 and num2 == 1 then
               onTeleportSong('samtakoy', 2)

          elseif num1 == 69 and num2 == 12 then
               onTeleportSong('poup', 2)

          elseif num1 == 30 and num2 == 3 then
               onTeleportSong('monochrome', 2)
...
function onCreate() 
     ...
     setTextFont('n1_shadow', 'Comic Sans MS.ttf')
     ...
     setTextFont('n1', 'Comic Sans MS.ttf')
     ...
     setTextFont('n2_shadow', 'Comic Sans MS.ttf')
     ...
     setTextFont('n2', 'Comic Sans MS.ttf')
