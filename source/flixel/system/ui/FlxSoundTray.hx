...
class FlxSoundTray extends Sprite
{
	...
	public var volumeUpSound:String = "flixel/sounds/beep.ogg";

	/**The sound used when decreasing the volume.**/
	public var volumeDownSound:String = 'flixel/sounds/beep.ogg';
	...
	public function new()
	{
		...
		#else
		#end
		var dtf:TextFormat = new TextFormat(Paths.font("pixel.otf"), 15, 0xffffff);
